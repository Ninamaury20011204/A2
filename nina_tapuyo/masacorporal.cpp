...
using namespace std;// para ejecutar el cout y cin y std
int main ()//cuerpo del programa inicio y finaliza
{
	float imc,peso,altura;//declaramos los variables de imc,peso y altura
	cout<<"Ingrese el peso (kg): ";cin>>peso;// para mostrar mensaje en pantalla al usuario que ingrese y lo guardamos con cin.
	cout<<"Ingrese la altura (metros): ";cin>>altura;//pedimos al usuario que ingrese su altura y lo guardamos
	imc=peso/(altura*altura)//variable del imc general 
			;
	...
	if(imc>=35 && imc<39.9){//utilizamos si es verdadero la condicion de imc si mayor o menor a 39.9
